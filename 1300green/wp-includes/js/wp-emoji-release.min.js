...
var twemoji = function() {
        ...
        parse: function(d, u) {
            ...
            return ("string" == typeof d ? function(d, t) {
                return o(d, function(d) {
                    var u, f, e = d, c = x(d), a = t.callback(c, t);
                    if (a) {
                        for (f in e = "<img ".concat('class="', t.className, '" ', 'draggable="false" ', 'alt="', d, '"', ' src="', a, '"'),
                        u = t.attributes(d, c))
                            u.hasOwnProperty(f) && 0 !== f.indexOf("on") && -1 === e.indexOf(" " + f + "=") && (e = e.concat(" ", f, '="', u[f].replace(n, r), '"'));
                        e = e.concat("/>")
                    }
                    return e
                })
            ...
            : function(d, u) {
                var f, e, c, a, t, n, r, b, o, i, s, l = function d(u, f) {
                    var e, c, a = u.childNodes, t = a.length;
                    for (; t--; )
                        e = a[t],
                        3 === (c = e.nodeType) ? f.push(e) : 1 !== c || "ownerSVGElement"in e || h.test(e.nodeName.toLowerCase()) || d(e, f);
                    return f
                }(d, []), p = l.length;
                for (; p--; ) {
                    for (c = !1,
                    ...
                    r = 0; i = m.exec(n); ) {
                        ...
                        s = u.callback(i, u)) {
                            ...
                            f = u.attributes(o, i))
                                f.hasOwnProperty(e) && 0 !== e.indexOf("on") && !b.hasAttribute(e) && b.setAttribute(e, f[e]);
    ...
    function i(d, u) {
        for (var f = [], e = 0, c = 0, a = 0; a < d.length; )
            e = d.charCodeAt(a++),
            c ? (f.push((65536 + (c - 55296 << 10) + (e - 56320)).toString(16)),
            c = 0) : 55296 <= e && e <= 56319 ? c = e : f.push(e.toString(16));
        return f.join(u || "-")
    }
}();
